...
% Font settings - Source family with explicit variable font mapping (ensures bold/italic)
% Many systems install Google variable fonts (wght/opsz[/ital]). We explicitly map series/shape
% so that \bfseries and \itshape pick true weights instead of falling back to Regular.
...
% Mono font – Source Code Pro variable mapping
